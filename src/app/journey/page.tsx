                ...
                <div className="max-w-5xl mx-auto px-6 relative z-10">
                    <div className="space-y-16">
                        ...
                        <div className="border-l-2 border-white/10 pl-8 md:pl-12 relative group">
                            <div className="absolute -left-[5px] top-2 w-[8px] h-[8px] bg-primary rounded-full shadow-[0_0_10px_rgba(255,215,0,0.5)] group-hover:scale-150 transition-transform"></div>
                            <h3 className="text-2xl font-heading font-bold text-white uppercase tracking-wider mb-4">U.S. Marine Corps Veteran</h3>
                            ...
                            <div className="mt-8 relative h-[300px] md:h-[400px] w-full max-w-2xl rounded-xl overflow-hidden border border-white/10 group-hover:border-primary/50 transition-colors">
                                <Image src="/marine-corps-portrait.png" alt="U.S. Marine Corps Veteran" fill className="object-cover" />
                            </div>
                        </div>
                        ...
                        <div className="border-l-2 border-white/10 pl-8 md:pl-12 relative group">
                            <div className="absolute -left-[5px] top-2 w-[8px] h-[8px] bg-primary rounded-full shadow-[0_0_10px_rgba(255,215,0,0.5)] group-hover:scale-150 transition-transform"></div>
                            <h3 className="text-2xl font-heading font-bold text-white uppercase tracking-wider mb-4">Entrepreneur</h3>
                            <p className="text-lg text-gray-400 font-sans font-light leading-relaxed">
                            ...
                            <div className="mt-8 relative h-[300px] md:h-[400px] w-full max-w-2xl rounded-xl overflow-hidden border border-white/10 group-hover:border-primary/50 transition-colors">
                                <Image src="/entrepreneur-office.png" alt="Entrepreneur" fill className="object-cover object-[center_20%]" />
                            </div>
                        </div>
                        ...
                        <div className="border-l-2 border-white/10 pl-8 md:pl-12 relative group">
                            <div className="absolute -left-[5px] top-2 w-[8px] h-[8px] bg-primary rounded-full shadow-[0_0_10px_rgba(255,215,0,0.5)] group-hover:scale-150 transition-transform"></div>
                            <h3 className="text-2xl font-heading font-bold text-white uppercase tracking-wider mb-4">National Media Voice</h3>
                            <p className="text-lg text-gray-400 font-sans font-light leading-relaxed">
                            ...
                            <div className="mt-8 relative h-[300px] md:h-[400px] w-full max-w-2xl rounded-xl overflow-hidden border border-white/10 group-hover:border-primary/50 transition-colors">
                                <Image src="/news-anchor.png" alt="National Media Voice" fill className="object-cover" />
                            </div>
                        </div>
                        ...
                        <div className="border-l-2 border-white/10 pl-8 md:pl-12 relative group">
                            <div className="absolute -left-[5px] top-2 w-[8px] h-[8px] bg-primary rounded-full shadow-[0_0_10px_rgba(255,215,0,0.5)] group-hover:scale-150 transition-transform"></div>
                            <h3 className="text-2xl font-heading font-bold text-white uppercase tracking-wider mb-4">Congressional Candidate</h3>
                            <p className="text-lg text-gray-400 font-sans font-light leading-relaxed">
                            ...
                            <div className="mt-8 relative h-[300px] md:h-[400px] w-full max-w-2xl rounded-xl overflow-hidden border border-white/10 group-hover:border-primary/50 transition-colors">
                                <Image src="/congressional-candidate.png" alt="Congressional Candidate" fill className="object-cover" />
                            </div>
                        </div>
                        ...
                        <div className="border-l-2 border-white/10 pl-8 md:pl-12 relative group">
                            <div className="absolute -left-[5px] top-2 w-[8px] h-[8px] bg-primary rounded-full shadow-[0_0_10px_rgba(255,215,0,0.5)] group-hover:scale-150 transition-transform"></div>
                            <h3 className="text-2xl font-heading font-bold text-white uppercase tracking-wider mb-4">Filmmaker & Media Creator</h3>
                            <p className="text-lg text-gray-400 font-sans font-light leading-relaxed">
                            ...
                            <div className="mt-8 relative h-[300px] md:h-[400px] w-full max-w-2xl rounded-xl overflow-hidden border border-white/10 group-hover:border-primary/50 transition-colors">
                                <Image src="/film-set-direction.png" alt="Filmmaker" fill className="object-cover" />
                            </div>
                        </div>
                        ...
                        <div className="border-l-2 border-white/10 pl-8 md:pl-12 relative group">
                            <div className="absolute -left-[5px] top-2 w-[8px] h-[8px] bg-primary rounded-full shadow-[0_0_10px_rgba(255,215,0,0.5)] group-hover:scale-150 transition-transform"></div>
                            <h3 className="text-2xl font-heading font-bold text-white uppercase tracking-wider mb-4">Professional Sports Owner</h3>
                            <p className="text-lg text-gray-400 font-sans font-light leading-relaxed">
                            ...
                            <div className="mt-8 relative h-[300px] md:h-[400px] w-full max-w-2xl rounded-xl overflow-hidden border border-white/10 group-hover:border-primary/50 transition-colors">
                                <Image src="/arena-basketball.png" alt="Professional Sports Owner" fill className="object-cover" />
                            </div>
                        </div>
                        ...
                        <div className="border-l-2 border-white/10 pl-8 md:pl-12 relative group pb-12">
                            <div className="absolute -left-[5px] top-2 w-[8px] h-[8px] bg-primary rounded-full shadow-[0_0_10px_rgba(255,215,0,0.5)] group-hover:scale-150 transition-transform"></div>
                            <h3 className="text-2xl font-heading font-bold text-white uppercase tracking-wider mb-4">Hollywood Finance & Film Disruptor</h3>
                            <p className="text-lg text-gray-400 font-sans font-light leading-relaxed">
                            ...
                            <div className="mt-8 relative h-[300px] md:h-[400px] w-full max-w-2xl rounded-xl overflow-hidden border border-white/10 group-hover:border-primary/50 transition-colors">
                                <Image src="/hollywood-night.png" alt="Hollywood Finance" fill className="object-cover" />
                            </div>
                        </div>
                    </div>
                </div>
